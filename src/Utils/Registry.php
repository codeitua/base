...
class Registry extends ArrayObject
{
     ...
     * @var string
     */
    private static $registryClassName = self::class;
    /**
     ...
     */
    public static function setClassName($registryClassName = 'Utils\\Registry')
    {
        if (self::$registry !== null) {
            throw new RuntimeException('Registry is already initialized');
        }
        ...
        if (!class_exists($registryClassName)) {
            throw new DomainException(sprintf('%s expects a valid registry class name; received "%s", which did not resolve', __METHOD__, $registryClassName));
        }
     ...
     *
     * This method can be called from an object of type Laminas_Registry, or it
