...
abstract class AbstractController extends AbstractActionController
{
    ...
    * @param bool $isAdmin;
    */
    protected function setBreadcrumbs($data = [], $isAdmin = false)
    {
        $this->breadcrumbs = [];
    ...
    */
    public function setEventManager(EventManagerInterface $eventManager)
    {
        ...
        $eventManager->attach('dispatch', function ($e) use($controller) {
            ...
            if ($response !== false) {
                if ($response instanceof \Laminas\View\Model\ViewModel) {
                    return $response;
                }
    ...
    */
    ...
    {
        $view = new \Laminas\View\Model\ViewModel(['err' => $mess]);
    ...
    */
    public function renderHtmlIntoLayout($layoutVariable, $viewTemplate, $viewData = [])
    {
    ...
    */
    public function sendJSONResponse($data = [], $view = false, $action = 'content', $status = 'success', $exit = false)
    {
        ...
        $result = ['status' => $status, 'action' => $action, 'content' => $content, 'data' => $data];
        $jsonView = new ViewModel(['json' => $result, 'jsonFormat' => $this->jsonFormat]);
